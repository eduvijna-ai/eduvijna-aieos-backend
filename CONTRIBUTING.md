...
These rules mirror the contribution rules of [eduvijna-architecture](https://github.com/eduvijna-ai/eduvijna-architecture) and [eduvijna-product](https://github.com/eduvijna-ai/eduvijna-product), adapted for backend implementation (not EAO governance or product-intelligence directories).
