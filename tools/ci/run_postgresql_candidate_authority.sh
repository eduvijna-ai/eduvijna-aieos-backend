...
[[ "$head_rev" == "pedi090002" ]] || fail "expected head pedi090002 after upgrade, got ${head_rev}"
infra_revoke_and_baseline
...
run_alembic_as_migrator upgrade head
head_rev="$(psql_query -c "SELECT version_num FROM alembic_version")"
[[ "$head_rev" == "pedi090002" ]] || fail "expected pedi090002 after re-upgrade, got ${head_rev}"
infra_revoke_and_baseline
