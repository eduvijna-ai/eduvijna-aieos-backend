...
[[ "$head_rev" == "a360s010003" ]] || fail "expected head a360s010003 after upgrade, got ${head_rev}"
infra_revoke_and_baseline
...
run_alembic_as_migrator upgrade head
head_rev="$(psql_query -c "SELECT version_num FROM alembic_version")"
[[ "$head_rev" == "a360s010003" ]] || fail "expected a360s010003 after re-upgrade, got ${head_rev}"
infra_revoke_and_baseline
