...
_ASSESSMENT_PROBLEMS: dict[
    ...
    LearnerSubmissionNotFound: (
        404,
        "learner_submission_not_found",
        "LearnerSubmission not found",
        "LearnerSubmission was not found",
    ),
    EvaluationLineageConflict: (
        409,
        "evaluation_lineage_conflict",
        "Evaluation lineage conflict",
        "Submission, assignment, and ContentVersion lineage do not agree",
    ),
    EvaluationContentUnsupported: (
        422,
        "evaluation_content_unsupported",
        "Evaluation content unsupported",
